...
class Settings:
    ...
    def load_from_file(cls) -> "Settings":
        ...
        _ = config.read(result.get_config_path())
    ...
    def generate_config(cls) -> None:
        ...
        print(
            f"Config Generated at {cls.get_config_path()}. Please edit and restart this program."
        )
    ...
    def parse_args(cls):
        ...
        _ = parser.add_argument(
            "-m", "--magick", default=result.magick, help="Path to magick/convert"
        )
        _ = parser.add_argument(
            "--temp", default=result.temp, help="Temporary Directory"
        )
        ...
        _ = parser.add_argument(
            "-n", "--frames", type=int, required=True, help="Number of Frames to render"
        )
        _ = parser.add_argument(
            "-f",
            "--file",
        ...
        _ = parser.add_argument(
            "-o", "--output", required=True, help="Output file (.gif)"
        )
